...
class HelloModalForm extends FormBase {
  public function buildForm(array $form, FormStateInterface $form_state) {
      ...
      $form['actions']['submit'] = array(
        '#type' => 'submit',
        '#value' => $this->t('Search'),
        // here we add Ajax callback where we will process // the data that came from the form and that we will receive as a result in the modal window 
        '#ajax' => array( 'callback' => '::open_modal',  
